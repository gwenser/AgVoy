...
";
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["unavailable_period"] ?? null), "id", [], "any", false, false, false, 12), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>BeginDate</th>
                <td>";
        // line 16
        ((twig_get_attribute($this->env, $this->source, ($context["unavailable_period"] ?? null), "beginDate", [], "any", false, false, false, 16)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["unavailable_period"] ?? null), "beginDate", [], "any", false, false, false, 16), "Y-m-d"), "html", null, true))) : (print ("")));
        echo "</td>
            </tr>
            <tr>
                <th>EndDate</th>
                <td>";
        // line 20
        ((twig_get_attribute($this->env, $this->source, ($context["unavailable_period"] ?? null), "endDate", [], "any", false, false, false, 20)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["unavailable_period"] ?? null), "endDate", [], "any", false, false, false, 20), "Y-m-d"), "html", null, true))) : (print ("")));
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("unavailable_period_edit", ["id" => twig_get_attribute($this->env, $this->source, ($context["unavailable_period"] ?? null), "id", [], "any", false, false, false, 27)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "unavailable_period/show.html.twig", "/home/serandour/Couette_et_café_final/AgVoy/templates/unavailable_period/show.html.twig");
    }
}
