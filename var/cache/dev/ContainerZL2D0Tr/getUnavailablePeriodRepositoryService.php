...
return $this->privates['App\\Repository\\UnavailablePeriodRepository'] = new \App\Repository\UnavailablePeriodRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
